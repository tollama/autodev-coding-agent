...
EVENT_REGISTRY: tuple[EventRegistryEntry, ...] = (
    EventRegistryEntry(
        ...
        spec=CanonicalEventSpec(
            ...
            closure_status="🚧 Open — closure blocked (pending merge/completion evidence)",
        ),
    ),
    EventRegistryEntry(
    ...
    EventRegistryEntry(
        ...
        spec=CanonicalEventSpec(
            ...
            plan_av4_snapshot="- AV4 wave (`AV4-001` ~ `AV4-014`) is complete and closed on `main`.",
            backlog_title="# BACKLOG — Next Wave (Post-AV4 Intake Queue)",
            backlog_av4_snapshot="- AV4 closure: ✅ complete (`AV4-001` ~ `AV4-014`)",
