...
| AV6-002 | P0 | S | 🚧 Planned | Scoring threshold matrix (pass/retry/escalate/stop) | threshold bands and tie-break rules are defined with deterministic decision table and fallback semantics | threshold table review + `make check-docs` | 1 PR |
