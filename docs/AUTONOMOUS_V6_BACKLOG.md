...
| AV6-005 | P1 | S | ✅ Merged | Execution transition docs/status-hook update for AV6 | Live docs are moved from kickoff to execution using the canonical status-hook automation path without expanding stabilization/closure scope | `make check-status-hooks` + docs diff review | 1 PR |
